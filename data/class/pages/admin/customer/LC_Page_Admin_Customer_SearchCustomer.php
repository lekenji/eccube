 ...
 * @version $Id: LC_Page_Admin_Customer_SearchCustomer.php 23606 2014-08-27 10:08:02Z kimoto $
 */
class LC_Page_Admin_Customer_SearchCustomer extends LC_Page_Admin_Ex
{
    ...
    public function lfInitParam(&$objFormParam)
    {
        SC_Helper_Customer_Ex::sfSetSearchParam($objFormParam);
         $objFormParam->addParam('TypeCustomer', 'search_customer_type', INT_LEN, 'n', array('NUM_CHECK', 'MAX_LENGTH_CHECK'));
    }
