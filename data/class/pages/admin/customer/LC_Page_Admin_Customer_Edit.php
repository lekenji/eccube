 ...
 * @version $Id: LC_Page_Admin_Customer_Edit.php 23606 2014-08-27 10:08:02Z kimoto $
 */
class LC_Page_Admin_Customer_Edit extends LC_Page_Admin_Ex {
    ...
    public function action() {
        global $arrTypeCustomer;
        $this->arrTypeCustomer = $arrTypeCustomer;
        // パラメーター管理クラス
    ...
    public function lfInitParam(&$objFormParam) {
        ...
        $objFormParam->addParam('Type Customer', $prefix . 'typecustomer', INT_LEN, 'n', array('NUM_CHECK', 'MAX_LENGTH_CHECK'));
        // 検索結果一覧画面への戻り用パラメーター
