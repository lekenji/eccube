<?php /* Smarty version 2.6.27, created on 2014-12-17 13:24:44
         compiled from customer/edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'customer/edit.tpl', 28, false),array('modifier', 'h', 'customer/edit.tpl', 43, false),array('modifier', 'default', 'customer/edit.tpl', 116, false),array('modifier', 'sfDispDBDate', 'customer/edit.tpl', 300, false),array('modifier', 'n2s', 'customer/edit.tpl', 302, false),array('function', 'sfSetErrorStyle', 'customer/edit.tpl', 82, false),array('function', 'html_radios', 'customer/edit.tpl', 83, false),array('function', 'html_options', 'customer/edit.tpl', 116, false),)), $this); ?>
...
<?php endif; ?> >
             ...
             <tr>
                <th>Type Customer</th>
                <td>
                    <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr']['typecustomer'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                    <select name="typecustomer" <?php if (((is_array($_tmp=$this->_tpl_vars['arrTypecustomer']['typecustomer'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ""): ?><?php echo SC_Utils_Ex::sfSetErrorStyle(array(), $this);?>
<?php endif; ?> >
                    <option value="" selected="selected">選択してください</option>
                    <?php echo smarty_function_html_options(array('options' => ((is_array($_tmp=$this->_tpl_vars['arrTypeCustomer'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm']['typecustomer'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
