        ...
        <table class="form">
            ...
            <tr>
             ...
             <tr>
                <th>Type Customer</th>
                <td>
                    <span class="attention"><!--{$arrErr.typecustomer}--></span>
                    <select name="typecustomer" <!--{if $arrTypecustomer.typecustomer != ""}--><!--{sfSetErrorStyle}--><!--{/if}--> >
                    <option value="" selected="selected">選択してください</option>
                    <!--{html_options options=$arrTypeCustomer selected=$arrForm.typecustomer}-->
                    </select>
                </td>
            </tr>
            <tr>
